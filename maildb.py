...
# Displaying Sender and the SUbjects of allmails in the mailbox
    while i<len(email_id):
        ...
        print '\nSubject : '
        print allsubs[i]
        cursor.execute('INSERT INTO mails VALUES (%s,"internatrails@gmail.com",%s,%s,"+919940138729",NULL,0)',(email_id[i],allfroms[i],allsubs[i][0:100]))
